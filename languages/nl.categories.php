...
if (elgg_is_active_plugin("categories")) {
	$language = array (
	  ...
	  'categories:explanation' => 'Geef hieronder een aantal voorgedefinieerde categorieën in. Deze kunnen over hele site worden gebruikt. Je kunt meerdere categorieën opgeven, door een komma gescheiden. Geschikte plugins zullen deze dan weergeven als een gebruiker content bewerkt of aanmaakt.',
