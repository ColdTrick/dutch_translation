...
if(elgg_is_active_plugin("developers")){
	$language = array (
	  ...
	  'developers:label:view_path_cache' => 'Gebruik view path cache',
	  'developers:help:view_path_cache' => 'Zet dit uit tijdens het ontwikkelen. Anders zullen nieuwe views in je plugins niet worden geregistreerd.',
