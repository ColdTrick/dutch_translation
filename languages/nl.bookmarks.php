...
%s',
	  ...
	  'bookmarks:river:annotate' => 'Eén reactie op deze favoriet',
	  ...
	  'bookmarks:bookmarklet:group' => 'Verkrijg groepsbookmarklet',
	  ...
	  'bookmarks:bookmarklet:description' => 'De favorieten Browser plugin maakt het mogelijk om iedere willekeurige pagina te delen met je vrienden, of om gewoon voor jezelf om te onthouden. Om deze te gebruiken sleep je de Browser plugin naar je Links balk van je browser: ',
