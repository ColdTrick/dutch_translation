...
$language = array (
  'twitter_api:post_to_twitter' => 'Plaats Wire-berichten van gebruikers op Twitter?',
  ...
  'twitter_api:usersettings:cannot_revoke' => 'Je kunt je account niet ontkoppelen van Twitter omdat je geen e-mailadres of wachtwoord hebt opgegeven. <a href="%s">Vul ze nu in</a>',
  ...
  'twitter_api:interstitial:description' => 'Je bent bijna klaar om gebruik te maken van %s! We hebben nog een paar gegevens nodig voordat je verder kunt. Deze zijn optioneel, maar maken het mogelijk dat je je kunt aanmelden als Twitter niet beschikbaar is of als je de koppeling met Twitter verwijdert.',
  'twitter_api:interstitial:username' => 'Dit is je gebruikersnaam. Dit kan niet worden aangepast. Als je een wachtwoord opgeeft, kun je je aanmelden met deze gebruikersnaam of je e-mailadres.',
  'twitter_api:interstitial:name' => 'Dit is de naam die mensen zien als ze met jou corresponderen.',
  'twitter_api:interstitial:email' => 'Je e-mailadres. Gebruikers kunnen dit standaard niet zien.',
  ...
  'twitter_api:interstitial:invalid_email' => 'Je moet een geldige-mail adres opgeven, of niets.',
  ...
  'twitter_api:interstitial:cannot_save' => 'De accountgegevens kunnen niet worden opgeslagen.',
  'twitter_api:interstitial:saved' => 'Accountgegevens opgeslagen!',
);
