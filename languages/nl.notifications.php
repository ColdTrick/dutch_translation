...
if (elgg_is_active_plugin("notifications")) {
	$language = array (
	  ...
	  'notifications:subscriptions:personal:description' => 'Ontvang een notificatie als er acties worden ondernomen op jouw content, bijvoorbeeld als er een reactie gegveen wordt.',
	  ...
	  'notifications:subscriptions:groups:description' => 'Wil je een notificatie ontvangen wanneer er nieuwe content is in een groep waarvan je lid bent? Zoek de groep hieronder op en selecteer de wijze die je wilt gebruiken.',
