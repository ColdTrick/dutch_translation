...
%s',
	  ...
	  'groups:closedgroup' => 'Deze groep is besloten. Wil je  lid te worden> Klik dan op de menulink "Verzoek lidmaatschap".',
	  ...
	  'groups:invite:subject' => 'Beste %s, je bent uitgenodigd om lid te worden van %s!',
