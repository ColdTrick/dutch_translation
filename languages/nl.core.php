...
$language = array (
  ...
  'SecurityException:UnexpectedOutputInGatekeeper' => 'Onverwachte uitvoer in gatekeeper aanroep. Verwerking is gestopt om beveiliging redenen. Bezoek http://docs.elgg.org/ voor meer informatie.',
...
<dt>Ontwikkel</dt><dd>Voor ontwikkelaars die plugin maken of themes ontwikkelen. (Vereist een ontwikkelaars plugin.)</dd>
  ...
  'admin:plugins:simple' => 'Eenvoudig',
  'admin:plugins:advanced' => 'Geavanceerd',
  'admin:plugin_settings' => 'Plugin instellingen',
  'admin:plugins:simple_simple_fail' => 'Instellingen konden niet worden opgeslagen.',
  'admin:plugins:simple_simple_success' => 'Instellingen opgeslagen.',
  'admin:plugins:simple:cannot_activate' => 'Kon de plugin niet activeren. Controleer het geavanceerde plugin beheer gedeelte voor meer informatie.',
